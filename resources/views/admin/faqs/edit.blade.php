                    ...
                    <form method="POST"
                            ...
                            <select id="faq_category_id"
                                ...
                                @foreach ($faqCategories as $faqCategory)
                                    <option value="{{ $faqCategory->id }}"
                                            @if (old('faq_category_id', $faq->faq_category_id) == $faqCategory->id) selected @endif>
                                        {{ $faqCategory->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <textarea id="answer"
                                      ...
                                      required
                                      maxlength="2000"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('answer', $faq->answer) }}</textarea>
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox"
                                       name="is_visible"
                                       value="1"
                                       @if (old('is_visible', $faq->is_visible)) checked @endif
