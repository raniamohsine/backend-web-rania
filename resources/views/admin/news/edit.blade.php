           ...
           style="background-color: #2563eb; color: white; padding: 12px 24px; border-radius: 6px; font-weight: bold; cursor: pointer;">
                        ...
                        <div>
                            ...
                            <input id="published_at"
                                   name="published_at"
                                   type="date"
                                   value="{{ old('published_at', $newsItem->published_at) }}"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <div>
                            ...
                            <textarea id="content"
                                      ...
                                      rows="8"
                                      required
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('content', $newsItem->content) }}</textarea>
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox"
                                       name="is_published"
                                       value="1"
                                       @if (old('is_published', $newsItem->is_published)) checked @endif
